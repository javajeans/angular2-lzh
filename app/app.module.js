...
var heroes_component_1 = require("./component/heros/heroes.component");
    ...
    AppModule = __decorate([
        core_1.NgModule({
            imports: [
                ...
                http_1.HttpModule,
                angular_in_memory_web_api_1.InMemoryWebApiModule.forRoot(in_memory_data_service_1.InMemoryDataService) //InMemoryWebApiModule 将 Http 客户端默认的后端服务（这是一个辅助服务，负责与远程服务器对话）替换成了 内存 Web API 服务
            ],
            declarations: [
